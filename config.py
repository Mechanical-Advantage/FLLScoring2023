...
schedule_judging_rooms = []  # for judging overview
...
schedule_judging_inlength = 0  # secs, how long does each judging session take?
schedule_judging_outlength = 0  # secs, how long should the break between judging sessions take?
schedule_judging_teamgrace = 0  # secs, how long before or after judging should a team be excluded from matches?
